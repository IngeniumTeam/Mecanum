...
{
    motors[Left][Front] = Motor(in1_1, in1_2, pwm1, 1, standBy1, fromMin, fromMax, toMin, toMax);
    motors[Left][Back] = Motor(in2_1, in2_2, pwm2, 1, standBy1, fromMin, fromMax, toMin, toMax);
    motors[Right][Front] = Motor(in3_1, in3_2, pwm3, 1, standBy2, fromMin, fromMax, toMin, toMax);
    motors[Right][Back] = Motor(in4_1, in4_2, pwm4, 1, standBy2, fromMin, fromMax, toMin, toMax);
}
